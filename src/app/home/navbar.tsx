...
const Navbar = () => {
    return (
        <div className='h-full overflow-y-auto border-r border-[#8899]'>
            <div className='w-[38px] md:w-full flex flex-col justify-center items-center md:justify-end md:items-end gap-2 md:gap-4 p-2 md:p-4'>
                ...
                <a href='/profile' className='cursor-pointer rounded-full hover:rounded-full hover:bg-[#999999] p-2 transition-colors duration-100'>
