...
const CreateAccount = () => {
  return (
    ...
    <div className='flex justify-center'>
      ...
      <div className='w-full rounded-3xl p-2 px-5 bg-[#fff] text-[#000] mt-5 cursor-pointer text-sm font-thin'>
        Create Account
      </div>
      ...
      <div className='w-full rounded-3xl p-2 px-5 bg-[#fff] text-[#8CCDEB] mt-3 cursor-pointer text-sm font-thin'>
        Sign in
      </div>
    </div>
  )
