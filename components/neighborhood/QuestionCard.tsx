    ...
    return (
        <div className="bg-white p-4 rounded-lg border border-gray-200">
            <div className="flex items-start gap-3">
                ...
                >
                    <img src={question.author.avatar} alt={question.author.name} className="w-10 h-10 rounded-full" />
                </button>
                    ...
                    {question.answers.map(answer => (
                         <div key={answer.id} className="flex items-start gap-2 mt-2">
                             <button onClick={() => onViewProfile(answer.author.id)} className="flex-shrink-0">
                                <img src={answer.author.avatar} alt={answer.author.name} className="w-8 h-8 rounded-full" />
                            </button>
