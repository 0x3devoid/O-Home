...
const DiscoverPost: React.FC<DiscoverPostProps> = ({ property, currentUser, onViewComments, isActive }) => {
  ...
  return (
    <div className="relative h-full w-full bg-black">
      {isVideo ? (
        <video ref={videoRef} src={mediaUrl} loop autoPlay muted playsInline className="h-full w-full object-cover" />
      ) : (
