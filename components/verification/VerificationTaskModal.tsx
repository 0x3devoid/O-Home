...
const VerificationTaskModal: React.FC<VerificationTaskModalProps> = ({ property, onAccept, onDecline }) => {
    return (
        <div className="absolute inset-0 bg-black/50 z-30 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
                ...
                <p className="mt-2 text-gray-600">
                    You are about to accept the 'Agent Bounty' for the property at <span className="font-semibold">{property.location}</span>.
                </p>
                <p className="mt-4 text-sm text-gray-500">
                    You will be connected with the lister, <span className="font-semibold">{property.lister.name}</span>, to arrange the verification.
                </p>
