...
const PrivacyToggle: React.FC<{ label: string, description: string, isEnabled: boolean, onToggle: (enabled: boolean) => void }> = ({ label, description, isEnabled, onToggle }) => (
...
const PrivacySettings: React.FC<PrivacySettingsProps> = ({ currentUser, onBack }) => {
