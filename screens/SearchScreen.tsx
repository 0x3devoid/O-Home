...
const SearchScreen: React.FC<SearchScreenProps> = ({ currentUser, allProperties, allNeighborhoods, onViewNeighborhood, onOpenCreateTeam, initialState, onClearInitialState, onMessageLister }) => {
  ...
  const filteredProperties = useMemo(() => {
    return allProperties
      .filter(property => {
        if (property.postType === 'text') return false; 
        ...
        <main className="flex-grow relative">
          {viewMode === 'map' ? (
            <MapView 
              ...
              onSelectNeighborhood={onViewNeighborhood} 
