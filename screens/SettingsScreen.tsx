...
import type { SettingsScreenView } from "@/lib/store"

interface SettingsScreenProps {
  onClose: () => void
  onNavigate: (screen: SettingsScreenView | "referral") => void
}

const SettingsItem: React.FC<{ label: string; icon: React.ElementType; onClick?: () => void }> = ({
  label,
  icon: Icon,
  onClick,
}) => (
